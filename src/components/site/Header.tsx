        ...
        >
          ...
          <div className="flex items-center gap-2 pl-2">
            <a
              ...
              className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-border text-[color:var(--ink)] transition hover:border-[color:var(--gold)] hover:text-[color:var(--gold)]"
            >
              <Facebook size={14} />
            </a>
            <a
          ...
          >
            ...
            <div className="flex items-center justify-center gap-3 pt-2">
              <a
                ...
                rel="noreferrer"
                aria-label="Facebook da Dra. Elaine Morch"
                className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-border text-[color:var(--ink)]"
              >
                <Facebook size={14} />
              </a>
              <a
